...
export function DataTableToolbar({ table, filterKeys }: { table: any; filterKeys: any }) {
  //IF any of the keys have a value
  const isFiltered = filterKeys.some((key: any) => table.getState().columnFilters[key]?.length > 0);
